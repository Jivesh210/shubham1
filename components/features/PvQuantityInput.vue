...
export default {
	...
	watch: {
		...
		currentQty: function () {
			if ( this.currentQty > this.product.productquantity ) this.currentQty = this.product.productquantity;
	...
	methods: {
		plusQty: function () {
			if ( this.currentQty < this.product.productquantity ) this.currentQty++;
